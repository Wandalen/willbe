...
_.assert( _.objectIs( _.field ), 'wModuleForTesting12 needs ModuleForTesting1/wtools/abase/l1/FieldMapper.s' );
_.assert( _.routineIs( _nameFielded ), 'wModuleForTesting12 needs ModuleForTesting1/wtools/l3/NameModuleForTesting1.s' );
