...
function openNamedFast( test )
{
  ...
  var opener1 = will.openerMakeManual({ willfilesPath : a.abs( 'super' ) });
  let ready1 = opener1.open();

  var opener2 = will.openerMakeManual({ willfilesPath : a.abs( 'super' ) });
  ...
  function check( opener )
  {
    ...
    test.identical( opener.openedModule.willPath, a.path.join( __dirname, '../will/entry/Exec' ) );
...
function openNamedForming( test )
{
  ...
  let opener1 = will.openerMakeManual({ willfilesPath : a.abs( 'super' ) });
  ...
  let opener2 = will.openerMakeManual({ willfilesPath : a.abs( 'super' ) });
  let ready2 = opener2.open();
...
function openAnon( test )
{
  ...
  var opener1 = will.openerMakeManual({ willfilesPath : a.abs( './' ) });
  let ready1 = opener1.open();
  var opener2 = will.openerMakeManual({ willfilesPath : a.abs( './' ) + '/' });
  let ready2 = opener2.open();
...
function moduleClone( test )
{
  ...
  a.ready.then( ( arg ) =>
  {
    ...
    test.identical( module2.willPath, a.path.join( __dirname, '../will/entry/Exec' ) );
    ...
    test.identical( opener2.openedModule.willPath, a.path.join( __dirname, '../will/entry/Exec' ) );
...
function exportDefaultPath( test )
{
  ...
  .then( () =>
  {
    ...
    a.reflect();
    opener = will.openerMakeManual({ willfilesPath : a.abs( 'path' ) });
    return opener.open();
  })
  ...
  .then( () =>
  {
    ...
    a.reflect();
    opener = will.openerMakeManual({ willfilesPath : a.abs( 'reflector' ) });
    return opener.open();
  })
  ...
  .then( () =>
  {
    ...
    a.reflect();
    opener = will.openerMakeManual({ willfilesPath : a.abs( 'nopath' ) });
    return opener.open();
  })
  ...
  .then( () =>
  {
    ...
    a.reflect();
    opener = will.openerMakeManual({ willfilesPath : a.abs( 'nofile' ) });
    return opener.open();
  })
  ...
  .then( () =>
  {
    ...
    a.reflect();
    opener = will.openerMakeManual({ willfilesPath : a.abs( 'nonglob' ) });
    return opener.open();
  })
...
function exportRecursive( test )
{
  ...
  .then( ( arg ) =>
  {
    ...
    test.description = 'outfile';
    var outfile = a.fileProvider.configRead( a.abs( 'out/ab/module-ab.out.will.yml' ) );
    var modulePaths = _.mapKeys( outfile.module );
...
function exportStepOpts( test )
{
  ...
  .then( () =>
  {
    ...
    a.reflect();
    a.fileProvider.filesDelete( a.abs( 'out' ) );
    opener = will.openerMakeManual({ willfilesPath : a.abs( 'a' ) });
    return opener.open();
  })
  ...
  .then( ( arg ) =>
  {
    ...
    test.description = 'outfile';
    var outfile = a.fileProvider.configRead( a.abs( 'out/module-a.out.will.yml' ) );
    var modulePaths = _.mapKeys( outfile.module );
  ...
  {
    test.case = 'reopen';
    opener = will.openerMakeManual({ willfilesPath : a.abs( 'out/module-a.out.will.yml' ) });
    return opener.open({ all : 1 });
  })
...
function exportRecursiveUsingSubmodule( test )
{
  ...
  .then( ( arg ) =>
  {
    ...
    test.description = 'sub outfile';
    var outfile = a.fileProvider.configRead( a.abs( 'sub.out/submodule.out.will.yml' ) );
    var modulePaths = _.mapKeys( outfile.module );
