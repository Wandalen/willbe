# <a name="glob-assertion"></a> Ґлоб з ассертом
...
**Ґлоб з ассертом (Обмеження селектора)** - обмеження вибірки селектора з ґлобом числовим значенням для  локалізації місця помилки та попередження виконання небажаних дій.  
