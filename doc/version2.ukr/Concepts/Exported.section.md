# Секція `exported` 
Секція `will-файла`, автоматично згенерованого при експортуванні модуля. Згенерований при експорті `some_name.out.will` використовується при імпорті підмодуля.  
