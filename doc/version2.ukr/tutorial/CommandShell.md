...
- Команда `.shell` ефективна в комбінації з командою `.each` - запускає операції в командній оболонці системи для підмодулів `вілфайла`, а також, для модулів в указаній директорії.
