# <a name="інтерфейс-командного-рядка"></a> Інтерфейс командного рядка

Як користуватися інтерфейсом командного рядка утиліти `willbe`. Застосування команд `.help` та `.list`
