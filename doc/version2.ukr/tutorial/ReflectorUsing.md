...
Якщо змінити в рефлекторі поле `recursive` до `0`, буде скопійовано саму директорію `proto` без додаткових файлів. 
...
- В рефлекторах, полем `recursive` встановлюються рівні зчитування файлової системи відносно вказаного шляху.
