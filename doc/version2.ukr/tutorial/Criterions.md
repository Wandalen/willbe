...
#### Kos : Треба переписувати, так як критеріон оркім 0, 1 може приймати ще рядкові значення і їх може бути більше ніж 2-ва.

#### Kos : всюди замість
В попередньому туторіалі ["Знайомство з вбудованими кроками системи"](PredefinedSteps.md) будувались окремі збірки та додавались кроки в секцію `step` щоб виконати необхідний сценарій
#### Kos : Нехай буде
В [попередньому туторіалі](PredefinedSteps.md) будувались окремі збірки та додавались кроки в секцію `step` щоб виконати необхідний сценарій
#### -
