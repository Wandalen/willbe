...
Приклад іллюструє простий вибір на основі одного критеріону `debug` зі значеннями `0` i `1`. Значення `0` i `1` можна замінити на `debug`, `release` та інші довільні числові і рядкові значення - доступ до ресурсу відкривається при співпадінні мап критеріонів.
