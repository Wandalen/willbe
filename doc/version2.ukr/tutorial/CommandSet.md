...
Як користуватись командою `.set` для зміни станів утиліти, наприклад, для зміни рівня вербальності.
...
Утиліта `willbe` призначена для побудови модульних систем. `Will-модуль`, як основна одиниця утиліти, складається з конфігураційного файла та файлів, що описаних в ньому. Тому, всі налаштування системи поміщені в `will-файлі`. Взаємодія з утилітою здійснюється через командний рядок системи і до цього моменту ви бачили ввід та результат, а внутрішні процеси були приховані. З командою `.set` можливо прослідкувати і за цим.  
...
<details>
    <summary><u>Вивід команди <code>will .set verbosity:4 ; .export</code> з `verbosity:4`</u></summary>
