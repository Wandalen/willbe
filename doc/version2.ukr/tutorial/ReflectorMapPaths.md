...
Поле `basePath` - вказує базову, початкову директорію, зазвичай, кореневу директорію файла - `.`.  
...
Запис зчитується так: переглянути файли в директорії `files`, в директорії `proto` виключити пошук. З вибірки виключити всі файли, які маються розширення `.js` та включити файли з розширенням `.md`. Скопійовані файли помістити в директорію `out`.
...
Провівши пошук в директоріях `files` утиліта знайшла лише файл `text.md`, а JavaScript файли та пошук в директорії `proto` виключила. 
