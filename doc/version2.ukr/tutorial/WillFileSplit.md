...
Внесіть в файли `.im.will.yml` i `package.json` приведений вище код.
...
Запустіть команду побудови модуля `.build` та перевірте зміни в структурі модуля.
...
Запущений пакетний менеджер NPM завантажив 48 пакетів залежностей. Побудова модуля завершена і можна створити його експортну конфігурацію.
