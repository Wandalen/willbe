...
Рефлектор використовує критеріон `debug : 0`, тому, в збірці побудови має бути критеріон `debug` зі значенням `0`.  
...
- Для використання рефлектора `predefined.debug` в збірці необхідно встановити критеріон `debug : 1`, а для `predefined.release` - `debug : 0`.
