...
Створіть директорію `list` з `will-файлом` та внесіть відповідний код.
...
- `predefined.will.files` - `will-файл` поточного модуля (або спліт-файли);  
- `predefined.dir` - шлях до директорії `will-файла` поточного модуля.  
