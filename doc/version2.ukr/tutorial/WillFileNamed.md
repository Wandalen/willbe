...
Створіть директорію `named` з приведеною конфігурацією. Скопіюйте приведений нижче код в файли з відповідними назвами.
...
В збірці `delete.out` виконується крок `delete.out` для видалення файлів з директорії `out`. Збі
