...
Утиліта `willbe` - система структурування даних. Адже,`вілфайл` дає розробнику чітке уявлення про структуру і призначення модуля завдяки зручному формату і формі запису. Тому, при побудові `вілфайла` потрібно виключити логічні помилки. Найпоширенішою помилкою є одночасне співпадання декількох ресурсів в вибірці селектора.  
