...
<a name="glob-assertion"></a> **Ґлоб з ассертом (Glob assertion) :: Обмеження селектора (Selector constraint).** Обмеження кількості ресурсів в вибірці селектора з ґлобом для попередження виконання небажаних дій.    
