...
| steps         | процедури створення модуля, описані секцією `step` або вбудовані в утиліта; необов'язкове поле                |
...
<details>
  <summary><u>Найпростіший will-файл з функцією встановлення утилітів NodeJS</u></summary>
