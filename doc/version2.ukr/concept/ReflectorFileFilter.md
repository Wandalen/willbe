...
Прості фільтри - це фільтри, які відбирають файли за назвою.
...
Виключати із вибірки файли можливо не лише фільтрами файлів, але і за допомогою мапи шляхів. Більш детальну інформацію можна отримати [тут](<./Reflectors.md#>).
