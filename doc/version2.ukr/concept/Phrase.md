...
Слово або декілька слів, відокремлених крапкою при вводі в командній оболонці системи. Крапка розділяє слова фрази на частини, що полегшує набір і зчитування.  

### <a name="command"></a> Команда
Команда - це фраза, котра складається із одного або більше слів. В утиліті `willbe` всі команди починаються з вводу `will .`.
Приклад команд:
