...
Для видалення файлів за вказаним шляхом    
...
Використання командної оболонки операційної системи

shell, currentPath, forEachDst, upToDate; (shell)
