...
```
Проста конфігурація - файли модуля поміщені в директорію за шляхом '/wSomeModule/proto/wtools/atop/someModuleName/'. Складна конфігурація від простої наявністю рівнів (layers) - розділення функціональностей модуля за ступенем важливості. Найвищий ступінь важливості - `l0` і знижується з кожним наступним ступенем.
