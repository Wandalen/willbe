...
| criterion                | критерії, експортовані з секції `build` при виконанні сценарію експорту |
| inherit                  | наслідування, яке експортується з секції `build` при виконанні сценарію |
